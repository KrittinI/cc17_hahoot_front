...
export default function CardBoxInProfile({ data, name, width = "full" }) {
  ...
  return (
    ...
    >
      <img className="rounded-t-lg w-full" src={data?.questionPicture || data?.eventImage || image} alt="Profile" />
