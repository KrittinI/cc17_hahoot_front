  ...
  return (
    <div
      className={`w-full items-center min-h-screen ${
        selectedAnswer ? "bg-opacity-80 bg-black" : ""
      }`}
    >
      <div className="w-[90%] mx-auto h-screen flex flex-col items-center justify-center gap-12 transition-all duration-300 ease-in-out transform">
        ...
        <div className="flex justify-between items-center animate-fade-in w-full">
          <span
            className={`flex items-center justify-center text-6xl text-white font-bold bg-timeLeft shadow-lg rounded-full w-[100px] h-[100px] ${
              selectedAnswer ? "invisible" : ""
            }`}
            style={{ minWidth: "40px" }}
          >
            {timeLeft}
          ...
          <img
            className={`max-w-[420px] max-h-[250px] rounded-lg ${
              selectedAnswer ? "invisible" : ""
            }`}
